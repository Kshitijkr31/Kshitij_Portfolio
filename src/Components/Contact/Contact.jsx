  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        ...
        "template_f4gitb4",  // Replace with your EmailJS Template ID
        form.current,
      ...
      <div className="mt-8 w-full max-w-md bg-[#0d081f] p-6 rounded-lg shadow-lg border border-gray-700">
        ...
        className="mt-4 flex flex-col space-y-4">
          <input
            ...
            required
            className="w-full p-3 rounded-md bg-[#131025] text-white border border-gray-600 focus:outline-none focus:border-dodger"
          />
          <input
            type="text"
            name="user_name"
